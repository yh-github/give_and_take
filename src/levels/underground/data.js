...
export const mapNodes = [
  { x: 50, y: 6, zone: 1, isPreset: 'mushroom' }, { x: 35, y: 12, zone: 1 }, { x: 65, y: 12, zone: 1 },
  { x: 33, y: 20, zone: 1, isGatekeeper: true, id: 'rock_left_1', emoji: '🪨', unlocksZones: [2] },
  { x: 67, y: 20, zone: 1, isGatekeeper: true, id: 'rock_right_1', emoji: '🪨', unlocksZones: [3] },
  { x: 22, y: 25, zone: 2, isPreset: 'pickaxe' },
  { x: 30, y: 30, zone: 2 }, { x: 30, y: 36, zone: 2 },
  { x: 70, y: 30, zone: 3 }, { x: 70, y: 36, zone: 3 },
  { x: 78, y: 38, zone: 3, isPreset: 'pickaxe' },
  { x: 33, y: 44, zone: 2, isGatekeeper: true, id: 'rock_left_2', emoji: '🪨', unlocksZones: [4] },
  { x: 67, y: 44, zone: 3, isGatekeeper: true, id: 'rock_right_2', emoji: '🪨', unlocksZones: [5] },
  { x: 40, y: 52, zone: 4 }, { x: 40, y: 58, zone: 4, isPreset: 'mushroom' },
  { x: 60, y: 52, zone: 5 }, { x: 60, y: 58, zone: 5 },
  { x: 50, y: 62, zone: 1, isPreset: 'pickaxe' },
  { x: 42, y: 66, zone: 4, isGatekeeper: true, id: 'rock_left_3', emoji: '🪨', unlocksZones: [6] },
  { x: 58, y: 66, zone: 5, isGatekeeper: true, id: 'rock_right_3', emoji: '🪨', unlocksZones: [6] },
