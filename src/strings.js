const STRINGS = {
  en: {
    ...
    specialVision: "Special Vision",
    radius: "Light Radius",
    blur: "Blur Effect",
    darknessColor: "Darkness Color",
    darknessOpacity: "Darkness Opacity",
    ambientColor: "Ambient Glow Color",
    ambientOpacity: "Glow Intensity",
    flicker: "Flicker Scale",
  ...
  he: {
    ...
    or: "או",
    lighting: "הגדרות תאורה",
    specialVision: "ראייה מיוחדת",
    radius: "רדיוס אור",
    blur: "טשטוש",
    darknessColor: "צבע חשיכה",
    darknessOpacity: "אטימות חשיכה",
    ambientColor: "צבע זוהר סביבתי",
    ambientOpacity: "עוצמת זוהר",
    flicker: "עוצמת הבהוב",
